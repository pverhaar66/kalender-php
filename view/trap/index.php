<center>
	...
	<main>
		...
		<table>
			<form method="GET" action="<?= URL ?>trap/trapSearch">
			<input id="searchtrap" type="text" name="search" placeholder=" Call of the Haunted"> <button id="searchbutton">Search</button>
			</form>
				<tr>
