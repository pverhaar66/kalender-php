...
<img id="header" src="<?= URL; ?>css/img/etc/header.jpg">
	...
	<section id="htpygo">
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-1.jpg">
		<p> 1.
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-2.jpg">
		<p>2.
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-3.jpg">
		<p>3
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-4.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-5.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-6.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-7.jpg">
		<p> 
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-8.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-9.jpg">
		<p> 
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-10.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-11.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-12.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-13.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-14.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-15.jpg">
		<p>	
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-16.jpg">
		<p>
		...
		<img id="header" src="<?= URL; ?>css/img/etc/Step-17.jpg">
		<p>
